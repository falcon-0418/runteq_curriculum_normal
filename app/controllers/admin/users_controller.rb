class Admin::UsersController < Admin::BaseController
  ...
  def update
    if @user.update(user_params)
      ...
      flash.now['danger'] = t('defaults.message.not_updates', item: User.model_name.human)
      render :edit
    end
  end
  ...
  def destroy
    @user.destroy!
    redirect_to admin_user_path, success: t('defaults.message.deleted', itme: User.model_name.human)
  end
